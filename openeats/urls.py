...
urlpatterns = patterns('',
    ...
    (r'^accounts/signIn/$', 'openeats.accounts.views.signIn_page'),
    (r'^friends/', include('openeats.friends.urls')),
    (r'^feed/', include('openeats.feed.urls')),
    (r'^groups/', include('openeats.recipe_groups.urls')),
    (r'^recipe/', include('openeats.recipe.urls')),
    (r'^ingredient/', include('openeats.ingredient.urls')),
    (r'^list/', include('openeats.list.urls')),
    (r'^tags/', include('openeats.tags.urls')),
    (r'^news/', include('openeats.news.urls')),
